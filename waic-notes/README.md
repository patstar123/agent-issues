...
> 随看随记；按厂家落盘，避免对话上下文过长丢失。
> 约定：每 1–2 轮对话，或一个厂家参观结束后，整理沉淀到本目录。

## 目录

| 厂家 | 文件 | 状态 |
|------|------|------|
| WPS | [vendors/wps.md](vendors/wps.md) | 已沉淀 |
| 瑞幸 × 火山引擎 | [vendors/luckin-volcengine.md](vendors/luckin-volcengine.md) | 已沉淀 |
| 蜜度（midu） | [vendors/midu.md](vendors/midu.md) | 已沉淀 |
...
| 分区 | 文件 | 说明 |
|------|------|------|
| 灵感 / 提效备忘 | [ideas.md](ideas.md) | 不归属具体厂家的零散记录 |
